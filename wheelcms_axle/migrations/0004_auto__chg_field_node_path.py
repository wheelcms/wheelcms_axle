...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Node.path'
        db.alter_column(u'wheelcms_axle_node', 'path', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))

    def backwards(self, orm):

        # Changing field 'Node.path'
        db.alter_column(u'wheelcms_axle_node', 'path', self.gf('django.db.models.fields.CharField')(max_length=1024, unique=True))
    ...
    models = {
        ...
        u'wheelcms_axle.content': {
            ...
            'expire': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2033, 7, 28, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
