...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        if db.backend_name != 'mysql':
            ## Can't reliably remove unique constraint, so constraint was
            ## removed in initial migration
        ...
        # Changing field 'Content.node'
        db.alter_column('wheelcms_axle_content', 'node_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['wheelcms_axle.Node']))

    def backwards(self, orm):
        # Deleting field 'Content.language'
        db.delete_column('wheelcms_axle_content', 'language')


        # Changing field 'Content.node'
        db.alter_column('wheelcms_axle_content', 'node_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['wheelcms_axle.Node']))
        # Adding unique constraint on 'Content', fields ['node']
        db.create_unique(u'wheelcms_axle_content', ['node_id'])
    ...
    models = {
        ...
        'wheelcms_axle.content': {
            ...
            'expire': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2033, 8, 15, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'wheelcms_axle.node': {
            ...
            'tree_path': ('django.db.models.fields.CharField', [], {'default': "'0x53bb30d0c336029cbL'", 'unique': 'True', 'max_length': '255'})
        },
        'wheelcms_axle.paths': {
