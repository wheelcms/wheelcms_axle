...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Content.discussable'
        db.add_column('wheelcms_axle_content', 'discussable',
                      self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Content.discussable'
        db.delete_column('wheelcms_axle_content', 'discussable')
    ...
    models = {
        ...
        'wheelcms_axle.content': {
            ...
            'expire': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2033, 6, 1, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
