...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Paths.path'
        db.alter_column(u'wheelcms_axle_paths', 'path', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Paths.path'
        db.alter_column(u'wheelcms_axle_paths', 'path', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        u'wheelcms_axle.content': {
            ...
            'expire': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2033, 8, 22, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'wheelcms_axle.node': {
            ...
            'tree_path': ('django.db.models.fields.CharField', [], {'default': "'0xe2c06bd7c0862568L'", 'unique': 'True', 'max_length': '255'})
        },
