...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Configuration.sender'
        db.add_column('wheelcms_axle_configuration', 'sender',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Configuration.sendermail'
        db.add_column('wheelcms_axle_configuration', 'sendermail',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Configuration.mailto'
        db.add_column('wheelcms_axle_configuration', 'mailto',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Configuration.sender'
        db.delete_column('wheelcms_axle_configuration', 'sender')

        # Deleting field 'Configuration.sendermail'
        db.delete_column('wheelcms_axle_configuration', 'sendermail')

        # Deleting field 'Configuration.mailto'
        db.delete_column('wheelcms_axle_configuration', 'mailto')
