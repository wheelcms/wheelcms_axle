...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'wheelcms_axle_node', 'tree_path', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Node.tree_path'
        db.delete_column(u'wheelcms_axle_node', 'tree_path')
    ...
    models = {
        ...
        u'wheelcms_axle.content': {
            ...
            'expire': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2033, 8, 14, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'wheelcms_axle.node': {
            ...
            'tree_path': ('django.db.models.fields.CharField', [], {'default': "'0x3a385a864690ece29L'", 'unique': 'True', 'max_length': '255'})
        },
