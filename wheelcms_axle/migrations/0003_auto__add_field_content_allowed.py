...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting field 'Content.allowed'
        db.delete_column('wheelcms_axle_content', 'allowed')
    ...
    models = {
        ...
        'wheelcms_axle.content': {
            ...
            'expire': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2034, 1, 6, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'wheelcms_axle.node': {
            ...
            'tree_path': ('django.db.models.fields.CharField', [], {'default': "'0x4db28989db2de5fb8L'", 'unique': 'True', 'max_length': '255'})
        },
        'wheelcms_axle.paths': {
