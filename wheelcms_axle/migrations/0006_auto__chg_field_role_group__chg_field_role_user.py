...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Role.group'
        db.alter_column('wheelcms_axle_role', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.Group']))

        # Changing field 'Role.user'
        db.alter_column('wheelcms_axle_role', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Role.group'
        raise RuntimeError("Cannot reverse this migration. 'Role.group' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Role.group'
        db.alter_column('wheelcms_axle_role', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group']))
        ...
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Role.user'
        db.alter_column('wheelcms_axle_role', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        'wheelcms_axle.node': {
            ...
            'tree_path': ('django.db.models.fields.CharField', [], {'default': "'0xdb77b9cea4d382bbL'", 'unique': 'True', 'max_length': '255'})
        },
        'wheelcms_axle.paths': {
        ...
        'wheelcms_axle.role': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'roles'", 'null': 'True', 'to': "orm['auth.Group']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
